...
const handler = require('../handlers/createAuthChallenge')
...
test('correct error thrown when no phone number found', async () => {
    let nullPhone = event;
    nullPhone.request.userAttributes.phone_number = null;
    let noPhone = event;
    delete noPhone.request.userAttributes.phone_number;
    let context = {};
